 ...
 * and session date — for the live/next-up webinar from `WebinarFacade`. The
 * actual registration form lives in the page hero, so this section's CTA
 * scrolls back up to it instead of mounting a second form.
 */
@Component({
...
export class CairaWebinarSection {
  ...
  protected readonly webinar = this.facade.liveOrNextUp;
