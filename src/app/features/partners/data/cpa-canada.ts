...
export const CPA_CANADA: PartnerLandingConfig = {
  pill: { brand: 'CPA Canada', brandClass: 'text-[#0680d1]' },
  /**
  ...
  contentSectionId: 'cpa-canada-content-section',

  benefits: {
    heading: 'Exclusive Benefits for Members of',
    highlight: { text: 'CPA Canada', class: 'text-[#0064A7]' },
    iconClass: 'size-6!',
  },
  audience: 'society',
  shortOffer: true,
  ...
  sectionId: 'cpa-canada-section',
  enquiryType: 'Canada CPA',
  keepUpdatedLabel: 'Keep me up to date on Miles Masterclass offerings.',
};
