...
export const MGI_NORTH_AMERICA: PartnerLandingConfig = {
  pill: { brand: 'MGI' },
  heroContent: [
    {
    ...
    },
    {
      logos: [
        {
          src: `${S3_BUCKET_URL}static-assests/web-app/partners/MGI-AREA-NORTH-AMER-LOGO.webp`,
          type: 'image',
          alt: 'MGI North America',
  ...
  contentSectionId: 'mgi-na-content-section',

  benefits: { heading: 'Exclusive Benefits for Member Firms of MGI North America' },
  audience: 'firm',
  planPointers: [
    {
      id: 1,
  ...
  footerContent: [
    {
      subHeading: 'Unlock your MGI North America member-firm benefit',
      subHeadingClass: 'text-white md:text-5xl text-3xl font-bold ',
  ...
  sectionId: 'mgi-na-section',
  enquiryType: 'MGI North America',
};
