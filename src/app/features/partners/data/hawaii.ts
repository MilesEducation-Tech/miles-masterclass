...
export const HSCPA: PartnerLandingConfig = {
  ...
  heroContent: [
    {
      ...
      logos: [
        {
          src: `${S3_BUCKET_URL}static-assests/web-app/partners/hscpa_logo.png.webp`,
          type: 'image',
          alt: 'Hawaii Society of CPAs',
          class: 'sm:h-25! h-21! w-auto! shrink-0',
        },
      ],
      //  class: 'sm:h-16! h-12! w-auto! shrink-0',
  ...
  contentSectionId: 'hawaii-content-section',
  ...
  footerContent: [
    {
      subHeadingHtml: 'Unlock your <span class="text-[#f9bb16]">HSCPA</span> Member Benefit',
      subHeadingClass: 'text-white md:text-5xl text-3xl font-bold ',
      itemClass: 'text-center py-4 md:w-2/3 w-full mx-auto',
    },
    {
  ...
  sectionId: 'hawaii-section',
  enquiryType: 'Hawaii Society of CPAs',
};
