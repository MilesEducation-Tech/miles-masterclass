...
export const DSCPA: PartnerLandingConfig = {
  pill: { brand: 'DSCPA' },
  heroContent: [
    {
      ...
      logos: [
        {
          src: `${S3_BUCKET_URL}static-assests/web-app/partners/dscpa-icon.webp`,
          type: 'image',
          alt: 'Delaware Society of CPAs',
  ...
  contentSectionId: 'delaware-content-section',

  benefits: { heading: 'Exclusive Benefits for Members of the Delaware Society of CPAs' },
  audience: 'society',
  planPointers: [
    {
      id: 1,
  ...
  footerContent: [
    {
      subHeading: 'Unlock your DSCPA Member Benefit',
      subHeadingClass: 'text-white md:text-5xl text-3xl font-bold ',
      itemClass: 'text-center py-4 md:w-2/3 w-full mx-auto',
    },
    {
  ...
  sectionId: 'delaware-section',
  enquiryType: 'Delaware Society of CPAs',
};
