...
export const MGI_WORLD: PartnerLandingConfig = {
  pill: { brand: 'MGI' },
  heroContent: [
    {
    ...
    },
    {
      logos: [
        {
          src: `${S3_BUCKET_URL}static-assests/web-app/partners/MGI-LOGO-NETWORK-WHITE.webp`,
          type: 'image',
          alt: 'MGI World Wide',
  ...
  contentSectionId: 'mgi-world-content-section',

  benefits: { heading: 'Exclusive Benefits for Member Firms of MGI Worldwide' },
  audience: 'firm',
  planPointers: [
    {
      id: 1,
  ...
  sectionId: 'mgi-world-section',
  enquiryType: 'MGI World',
};
