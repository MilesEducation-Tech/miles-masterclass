/**
 * Inline SVG marks used by the webinar surfaces.
 *
 * Kept as strings and handed to `<ng-icon [svg]="…">` rather than registered
 * through `provideIcons`, because these come from the design files rather than
 * an icon pack — there is no name to register them under, and a one-off
 * registration entry is indirection with nothing on the other end of it.
 */
