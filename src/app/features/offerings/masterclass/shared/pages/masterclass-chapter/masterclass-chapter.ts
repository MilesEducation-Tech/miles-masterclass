  ...
  constructor() {
    ...
    effect(() => {
      if (!this.auth.isLoggedIn()) {
        ...
        // Route structure: .../:courseId/:courseTitle/chapter/:chapterId/:chapterTitle
        // We want to go to: .../:courseId/:courseTitle
        // Remove last 3 segments: 'chapter', chapterId, chapterTitle
