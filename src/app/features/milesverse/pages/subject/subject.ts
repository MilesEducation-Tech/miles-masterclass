...
import { DIFFICULTY_TIERS, seedHue } from '../../models/milesverse.model';
import { difficultyColor } from '../../models/report.model';
...
@Component({
  ...
  styleUrls: ['../milesverse/milesverse.css', './subject.css'],
  providers: [
    provideIcons({
      lucideArrowDown,
      lucideArrowLeft,
