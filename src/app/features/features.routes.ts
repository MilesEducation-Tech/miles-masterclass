...
export const featuresRoutes: Route[] = [
  {
    ...
    children: [
      ...
      // routes stay lazy-loaded. `UaeCairaFacade` powers the CAIRA Levels
      // 1/2/3 carousels.
      {
        path: 'home',
      ...
      },
      {
        path: 'cpe-tracker',
        loadChildren: () =>
          import('@features/tracker/cpe/cpe-tracker.routes').then((m) => m.CpeTrackerRoutes),
      },
      {
        path: 'caira-tracker',
        loadChildren: () =>
      ...
      },
      {
        ...
        loadComponent: () =>
          import('@features/library/instructor/pages/instructor-details/instructor-details').then(
            (m) => m.InstructorDetails,
          ),
      },
      {
        path: 'connect-us',
      ...
      },
      {
        ...
        loadComponent: () =>
          import('@features/how-to-claim-credly-badge/pages/how-to-claim-credly-badge/how-to-claim-credly-badge').then(
...

      {
        path: 'faculty',
        loadComponent: () =>
          import('@features/faculty/pages/faculty/faculty').then((m) => m.Faculty),
      },
      {
