...
} from './shared/components/record-payment-dialog/record-payment-dialog';
import { UserOnboardingTable } from './shared/components/user-onboarding-table/user-onboarding-table';
import { UserOnboardingFacade } from './shared/services/user-onboarding-facade';
import { InternalUser } from './shared/models/user-onboarding.model';
