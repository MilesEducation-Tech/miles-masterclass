...
import { LeadsFacade } from './leads/shared/services/leads-facade';
import { UserReportFacade } from './user-report/shared/services/user-report-facade';
import { RbacFacade } from './roles-permissions/shared/services/rbac-facade';
      ...
      // out above; delete it once v2 has settled.
      {
        ...
        children: [
          ...
          },
          {
            ...
            canMatch: [permissionGuard(PERM.PARTNER_PLATFORM_MANAGE)],
            loadComponent: () =>
              import('./partner-platform-v2/firms/firms-v2').then((m) => m.FirmsV2),
          },
          {
            path: 'superadmin/codes',
            canMatch: [permissionGuard(PERM.PARTNER_PLATFORM_MANAGE)],
            loadComponent: () =>
              import('./partner-platform-v2/codes/codes-v2').then((m) => m.CodesV2),
          },
          {
            ...
            children: [
              {
                ...
                pathMatch: 'full',
                loadComponent: () =>
                  import('./partner-platform-v2/onboarding/onboarding-v2').then(
                    (m) => m.OnboardingV2,
                  ),
              },
              {
          ...
          },
          {
            ...
            loadComponent: () =>
              import('./partner-platform-v2/users/users-v2').then((m) => m.UsersV2),
          },
          {
