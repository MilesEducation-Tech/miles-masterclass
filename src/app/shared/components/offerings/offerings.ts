...
import type { HeroReelItem } from '@core/models/hero-reel-item.model';
import { DEFAULT_OFFERINGS, type OfferingData } from '@core/constants/offerings.config';

// Re-export so consumers (e.g. Laptop) can keep importing from '../offerings/offerings'.
export type {
  OfferingData,
  FloatingAsset,
  OfferingMockType,
} from '@core/constants/offerings.config';
