...
const CASES: Case[] = [
  ...
  // --- micro-learning: legacy `:type` listing-filter segment is dropped ---
  [
    '/accounting/micro-learning/course/29/stories-power-brands',
    'US',
    '/us/accounting/micro-learning/29/stories-power-brands',
    308,
  ],
  [
    '/accounting/micro-learning/track/29/stories-power-brands',
    'IN',
    '/in/accounting/micro-learning/29/stories-power-brands',
    308,
  ],
  ['/accounting/micro-learning/bookmark/7/slug', 'US', '/us/accounting/micro-learning/7/slug', 308],
  // id but no title slug → placeholder title (NOT courseId=`course`)
  [
    '/accounting/micro-learning/course/29',
    'US',
    '/us/accounting/micro-learning/29/micro-learning-course',
    308,
  ],
  // bare filter segment → listing
  ['/accounting/micro-learning/explore', 'US', '/us/accounting/micro-learning', 308],
  ['/accounting/micro-learning/inprogress', 'US', '/us/accounting/micro-learning', 308],
  ['/accounting/micro-learning/completed', 'US', '/us/accounting/micro-learning', 308],
  // a course id is NOT a filter word — feedback rule still wins
  [
    '/accounting/micro-learning/29/feedback/7',
    'US',
    '/us/accounting/micro-learning/29/micro-learning-course/feedback',
    307,
  ],

  // --- deprecated (interim fallback) ---
  ['/accounting/guides', 'US', '/us/accounting/home', 307],
  ['/accounting/become-an-instructor', 'US', '/us/accounting/home', 307],
  ['/accounting/sitemap', 'US', '/us/accounting/home', 307],
